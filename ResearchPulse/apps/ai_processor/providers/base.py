...
# -----------------------------------------------------------------------------
# 主分类定义
PRIMARY_CATEGORIES = {"AI", "编程", "研究", "创业", "金融", "设计", "技术", "其他"}

# 主分类 -> 子分类映射
SUBCATEGORIES = {
    "AI": ["大模型", "计算机视觉", "NLP", "机器学习", "多模态", "强化学习"],
    "编程": ["前端", "后端", "DevOps", "安全", "移动端"],
    "研究": ["论文", "理论", "方法"],
    "创业": ["融资", "产品", "运营"],
    "金融": ["投资", "分析"],
    "设计": ["UI/UX", "图形设计"],
...
# 兼容旧版本：VALID_CATEGORIES 仍为主分类集合
VALID_CATEGORIES = PRIMARY_CATEGORIES

# 分类别名映射表：将 AI 可能返回的近义词/变体统一映射到标准分类
CATEGORY_ALIASES = {
    "经济": "金融", "投资": "金融", "商业": "创业", "产品": "创业",
    "开发": "编程", "科研": "研究", "学术": "研究", "ML": "AI",
    "深度学习": "AI", "机器学习": "AI",  # 将旧的"机器学习"映射到"AI"
    "创新": "其他",  # 将旧的"创新"映射到"其他"
}
...
# 输出完整的结构化 JSON：摘要、分类、子分类、重要性、一句话总结、关键要点、影响评估、行动项
PROCESS_PROMPT = """分析内容，返回JSON（仅JSON，无其他文字）：
{{
  "summary": "50字中文摘要",
  "category": "主分类：AI|编程|研究|创业|金融|设计|技术|其他",
  "subcategory": "子分类（根据主分类选择，不确定可留空）",
  "importance": 1-10,
...
category：必须是8个主分类之一
subcategory：根据主分类选择对应子分类""" + SUBCATEGORY_HINT + """
...
# 仅输出四个核心字段：摘要、分类、子分类、重要性
SIMPLE_PROMPT = """返回JSON：{{"summary":"中文摘要50字内","category":"主分类：AI|编程|研究|创业|金融|设计|技术|其他","subcategory":"子分类（根据主分类选择）","importance":1-10}}
